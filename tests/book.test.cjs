...
test('book keeps full stories as text and orders journeys/memories by their dates',()=>{
 ...
 const input={exported_at:'2026-09-10T12:00:00Z',journeys:[{id:'b',title:'Later',start_date:'2025-01-01'},{id:'a',title:'Earlier',start_date:'1998-03-20',story}],memories:[{id:'2',journey_id:'a',title:'Second',memory_date:'1998-03-21',story:'two'},{id:'1',journey_id:'a',title:'First',memory_date:'1998-03-20',story:'one',clue:'Notice the old arch'}]};
 ...
 assert(nodes.some(n=>n.textContent==='Clue for later: Notice the old arch'));
